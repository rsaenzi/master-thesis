...
# Run experiments
echo 'Running 100M experiments with Proximal Policy Optimization (PPO) + Curricula C'
mlagents-learn 'master-thesis/SoccerExperiments/TrainingConfigPPO.yaml' --curriculum 'master-thesis/SoccerExperiments/TrainingCurriculaC.yaml' --env='master-thesis/SoccerExperiments/builds/linux_exe1/Linux_v12_9fields_Exe1.x86_64' --run-id=PPO_CurriculaC --num-envs 1 --no-graphics --force
