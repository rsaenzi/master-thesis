...
# chmod +x TrainingPPO_X.sh
# nohup ./TrainingPPO_X.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula X'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaX --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaX.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
