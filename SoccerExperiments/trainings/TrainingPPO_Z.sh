...
# chmod +x TrainingPPO_Z.sh
# nohup ./TrainingPPO_Z.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula Z'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaZ --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaZ.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
