...
# chmod +x TrainingPPO_Y.sh
# nohup ./TrainingPPO_Y.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula Y'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaY --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaY.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
