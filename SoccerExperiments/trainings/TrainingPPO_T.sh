...
# chmod +x TrainingPPO_T.sh
# nohup ./TrainingPPO_T.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula T'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaT --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaT.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
