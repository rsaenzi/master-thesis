...
# chmod +x TrainingPPO_only.sh
# nohup ./TrainingPPO_only.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO only'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=V2_PPO_only --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
