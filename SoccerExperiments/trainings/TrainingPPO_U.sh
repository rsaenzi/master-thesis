...
# chmod +x TrainingPPO_U.sh
# nohup ./TrainingPPO_U.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula U'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaU --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaU.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
