...
# chmod +x TrainingPPO_Q.sh
# nohup ./TrainingPPO_Q.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula Q'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaQ --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaQ.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
