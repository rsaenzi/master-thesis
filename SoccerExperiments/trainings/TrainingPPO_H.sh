...
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=V2_PPO_CurriculaH --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaH.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v13_1field.x86_64' --num-envs 1 --no-graphics --force
