...
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=V2_PPO_CurriculaG --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaG.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v13_1field.x86_64' --num-envs 1 --no-graphics --force
