...
# chmod +x TrainingPPO_V.sh
# nohup ./TrainingPPO_V.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula V'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaV --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaV.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
