...
# chmod +x TrainingPPO_S.sh
# nohup ./TrainingPPO_S.sh &
# tail -f nohup.out
...
# Run experiments
echo 'Experiment: PPO + Curricula S'
mlagents-learn 'master-thesis/SoccerExperiments/algorithms/AlgorithmPPO.yaml' --run-id=PPO_CurriculaS --curriculum 'master-thesis/SoccerExperiments/curriculums/CurriculaS.yaml' --env='master-thesis/SoccerExperiments/builds/Linux_v14_4fields.x86_64' --num-envs 1 --no-graphics --force
