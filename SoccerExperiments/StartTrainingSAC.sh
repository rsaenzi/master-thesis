...
echo
echo 'Running experiments with Soft Actor-Critic (SAC) + Curriculum Learning C:'
...
echo
echo 'Opening TensorBoard to see results for Soft Actor-Critic (SAC) + Curriculum Learning C:'
