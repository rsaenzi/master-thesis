...
# To make this file executable run 'chmod +x PlaySoccer.sh'
# To run this file open a terminal and run './PlaySoccer.sh'
...
#mlagents-learn -h
mlagents-learn config/trainer_config.yaml --env SoccerAcademy --force --run-id match_0 --save-freq 10000 --num-envs 1
